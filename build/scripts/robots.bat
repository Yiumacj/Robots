...
set CLASSPATH=%APP_HOME%\lib\robots-1.0.0.jar;%APP_HOME%\lib\gson-2.10.1.jar


@rem Execute robots
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ROBOTS_OPTS%  -classpath "%CLASSPATH%" gui.RobotsProgram %*
...
if not ""=="%ROBOTS_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
